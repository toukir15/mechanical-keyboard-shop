    ...
    <section className=" h-screen">
      <div className=" h-[calc(100vh-90px)] bg-cover bg-center hero-bg flex px-12 items-center relative">
        ...
        <div className="relative z-10 text-white flex flex-col gap-16 ">
          <p className="border-b-2 w-fit pb-3 border-primary text-xl font-medium leading-[35px] text-gray-200">
          ...
          <div className="flex gap-8 mt-6">
            <button className="bg-primary py-4 px-28 text-xl font-medium rounded ">
              See Products
            </button>
            <button className="bg-white text-primary py-4 px-28 text-xl font-medium rounded ">
              Learn More
            </button>
          </div>
        </div>
