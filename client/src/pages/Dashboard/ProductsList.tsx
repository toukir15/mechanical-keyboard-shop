...
export default function ProductsList() {
  ...
  return (
    <div className="mb-20 min-h-[calc(100vh-210px)] container mx-auto">
      <div className="flex mt-8 justify-end">
        <Link
          to={"/dashboard/add-product"}
          className="flex items-center gap-2 bg-orange-600 hover:bg-orange-700 transition duration-150  mx-4 justify-center rounded font-medium px-12 py-3 mt-8"
        >
          <button>Add Product</button>
        </Link>
      </div>
      <div className="overflow-x-auto md:overflow-x-hidden px-4">
            ...
            <tbody>
              {productsData.data.map((product: TProduct) => {
                return (
                  <tr
                    key={product._id}
                    className="border-b-[16px] border-[#121212] rounded-lg bg-[#f8f8f8d8] text-black cursor-pointer"
                  >
                    <td className="py-3 px-4 text-start">{product.name}</td>
                    <td className="py-3 px-4 text-start">
                      <img src={product.img} className="w-14 h-12" alt="" />
                    </td>
                    <td className="py-3 px-4 pl-6 text-start">
                      {product.brand}
                    </td>
                    <td className="py-3 px-4 text-start">
                    ...
                    <td className="py-3 px-4 pl-10 text-start">
                      <button
                        onClick={() =>
                    ...
                    <td
                      ...
                      className="py-3 px-4 pl-8 text-start"
                    >
                      <button>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
